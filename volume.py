...
#
# volume.AddRef                        volume.Release
# volume.GetChannelCount               volume.SetChannelVolumeLevel
# volume.GetChannelVolumeLevel         volume.SetChannelVolumeLevelScalar
# volume.GetChannelVolumeLevelScalar   volume.SetMasterVolumeLevel
# volume.GetMasterVolumeLevel          volume.SetMasterVolumeLevelScalar
# volume.GetMasterVolumeLevelScalar    volume.SetMute
# volume.GetMute                       volume.UnregisterControlChangeNotify
# volume.GetVolumeRange                volume.VolumeStepDown
# volume.GetVolumeStepInfo             volume.VolumeStepUp
# volume.QueryHardwareSupport          volume.from_param
# volume.QueryInterface                volume.value
